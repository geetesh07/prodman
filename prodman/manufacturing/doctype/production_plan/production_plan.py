...
from prodman.manufacturing.doctype.bom.bom import validate_bom_no
from prodman.manufacturing.doctype.work_order.work_order import get_item_details
from prodman.setup.doctype.item_group.item_group import get_item_group_defaults
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from prodman.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from prodman.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from prodman.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from prodman.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from prodman.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from prodman.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def create_work_order(self, item):
		from prodman.manufacturing.doctype.work_order.work_order import OverProductionError
