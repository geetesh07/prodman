...
from prodman.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
class TestSalesOrder(AccountsTestMixin, ntsTestCase):
	...
	def test_drop_shipping(self):
		...
		from prodman.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_make_work_order(self):
		from prodman.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from prodman.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_pick_list_for_batch(self):
		from prodman.stock.doctype.pick_list.pick_list import create_delivery_note
