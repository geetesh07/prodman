...
frappe.ui.form.on("Company", {
	...
	refresh: function (frm) {
		prodman.company.setup_queries(frm);
		...
		prodman.company.set_chart_of_accounts_options(frm.doc);
	},
...
prodman.company.setup_queries = function (frm) {
	$.each(
		[
		...
		function (i, v) {
			prodman.company.set_custom_query(frm, v);
		}
	);
...
prodman.company.set_custom_query = function (frm, v) {
	var filters = {
		company: frm.doc.name,
		is_group: 0,
	};
