...
from prodman.stock.serial_batch_bundle import BatchNoValuation, SerialNoValuation
from prodman.stock.valuation import FIFOValuation, LIFOValuation
...
def get_incoming_rate(args, raise_error_if_no_rate=True):
	...
	if in_rate is None:
		...
		in_rate = get_valuation_rate(
			...
			currency=prodman.get_company_currency(args.get("company")),
	...
	if reposting_pending and throw_error:
		...
		frappe.msgprint(
			...
			primary_action={
				...
				"client_action": "prodman.route_to_pending_reposts",
				"args": filters,
			},
		)
