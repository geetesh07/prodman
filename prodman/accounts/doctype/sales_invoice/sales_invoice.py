...
from prodman.accounts.party import get_due_date, get_party_account, get_party_details
...
from prodman.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from prodman.setup.doctype.company.company import update_company_current_month_sales
from prodman.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	if TYPE_CHECKING:
		...
		from prodman.accounts.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from prodman.accounts.doctype.sales_invoice_item.sales_invoice_item import SalesInvoiceItem
		from prodman.accounts.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from prodman.accounts.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
			SalesInvoiceTimesheet,
		)
		from prodman.accounts.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from prodman.selling.doctype.sales_team.sales_team import SalesTeam
		from prodman.stock.doctype.packed_item.packed_item import PackedItem
	...
	def set_pos_fields(self, for_validate=False):
		...
		from prodman.stock.get_item_details import get_pos_profile, get_pos_profile_item_details
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from prodman.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries
	...
	def get_gl_entries(self, warehouse_account=None):
		from prodman.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and prodman.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from prodman.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
