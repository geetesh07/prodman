...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from prodman.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from prodman.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser
