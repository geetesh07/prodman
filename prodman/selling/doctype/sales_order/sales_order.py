...
from prodman.stock.get_item_details import get_bin_details, get_default_bom, get_price_list_rate
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from prodman.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
