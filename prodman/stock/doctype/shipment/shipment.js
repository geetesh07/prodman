...
frappe.ui.form.on("Shipment", {
	...
	delivery_address_name: function (frm) {
		if (frm.doc.delivery_to_type == "Company") {
			prodman.utils.get_address_display(frm, "delivery_address_name", "delivery_address", true);
		} else {
			prodman.utils.get_address_display(frm, "delivery_address_name", "delivery_address", false);
		}
	},
	pickup_address_name: function (frm) {
		if (frm.doc.pickup_from_type == "Company") {
			prodman.utils.get_address_display(frm, "pickup_address_name", "pickup_address", true);
		} else {
			prodman.utils.get_address_display(frm, "pickup_address_name", "pickup_address", false);
		}
	},
