...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from prodman.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from prodman.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
