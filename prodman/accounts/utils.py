...
# imported to enable prodman.accounts.utils.get_account_currency
...
from prodman.stock.utils import get_stock_value_on
...
def reconcile_against_document(
	...
	for key, entries in reconciled_entries.items():
		...
		if voucher_type == "Payment Entry" and doc.book_advance_payments_in_separate_party_account:
			...
			from prodman.accounts.general_ledger import process_debit_credit_difference
...
def get_outstanding_invoices(
	...
	if account:
		...
		party_account_type = prodman.get_party_account_type(party_type)
...
def repost_gle_for_stock_vouchers(
	...
	from prodman.accounts.general_ledger import toggle_debit_credit_if_negative
	...
	journal_account = frappe._dict(
		{
			...
			"exchange_rate": 0,
			"cost_center": cost_center or prodman.get_default_cost_center(company),
