...
from prodman.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from prodman.maintenance.doctype.maintenance_schedule_item.maintenance_schedule_item import (
