...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from prodman.selling.doctype.quotation_item.quotation_item import QuotationItem
		from prodman.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from prodman.crm.doctype.lead.lead import _make_customer
