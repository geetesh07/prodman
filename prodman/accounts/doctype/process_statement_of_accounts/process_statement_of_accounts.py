...
from prodman.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from prodman.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from prodman.accounts.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from prodman.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from prodman.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from prodman.accounts.doctype.psoa_project.psoa_project import PSOAProject
