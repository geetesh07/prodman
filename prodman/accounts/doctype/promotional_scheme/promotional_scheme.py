...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from prodman.accounts.doctype.customer_item.customer_item import CustomerItem
		from prodman.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from prodman.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from prodman.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from prodman.accounts.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from prodman.accounts.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from prodman.accounts.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from prodman.accounts.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from prodman.accounts.doctype.supplier_item.supplier_item import SupplierItem
		from prodman.accounts.doctype.territory_item.territory_item import TerritoryItem
