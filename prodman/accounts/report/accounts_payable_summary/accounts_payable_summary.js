...
nts .query_reports["Accounts Payable Summary"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Payable"), function () {
			...
			nts .set_route("query-report", "Accounts Payable", { company: filters.company });
		});
	},
};

prodman.utils.add_dimensions("Accounts Payable Summary", 9);
