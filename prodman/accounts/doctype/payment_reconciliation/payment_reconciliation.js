			...
			this.frm.call({
				...
				callback: (r) => {
					if (r.message) {
						this.frm
							.call({
								method: "prodman.accounts.doctype.process_payment_reconciliation.process_payment_reconciliation.is_any_doc_running",
								args: {
									for_filter: {
										company: this.frm.doc.company,
...
extend_cscript(cur_frm.cscript, new prodman.accounts.PaymentReconciliationController({ frm: cur_frm }));
