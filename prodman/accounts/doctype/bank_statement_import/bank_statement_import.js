...
nts .ui.form.on("Bank Statement Import", {
	...
	export_errored_rows(frm) {
		open_url_post(
			"/api/method/prodman.accounts.doctype.bank_statement_import.bank_statement_import.download_errored_template",
			{
	...
	export_import_log(frm) {
		open_url_post(
			"/api/method/prodman.accounts.doctype.bank_statement_import.bank_statement_import.download_import_log",
			{
				data_import_name: frm.doc.name,
			}
		);
