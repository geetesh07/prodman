...
from prodman.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from prodman.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_uom_integer_validation(self):
		from prodman.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_new_sc_flow(self):
		from prodman.buying.doctype.purchase_order.purchase_order import make_subcontracting_order
