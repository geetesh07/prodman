...
prodman.accounts.payment_triggers.setup("Purchase Invoice");
prodman.accounts.taxes.setup_tax_filters("Purchase Taxes and Charges");
prodman.accounts.taxes.setup_tax_validations("Purchase Invoice");
prodman.buying.setup_buying_controller();

prodman.accounts.PurchaseInvoice = class PurchaseInvoice extends prodman.buying.BuyingController {
	setup(doc) {
...
cur_frm.script_manager.make(prodman.accounts.PurchaseInvoice);
