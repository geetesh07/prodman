...
from prodman.setup.doctype.brand.brand import get_brand_defaults
...
from prodman.stock.stock_ledger import NegativeStockError, get_previous_sle, get_valuation_rate
...
class StockEntry(StockController):
	...
	if TYPE_CHECKING:
		...
		from prodman.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from prodman.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def set_actual_qty(self):
		from prodman.stock.stock_ledger import is_negative_stock_allowed
		...
		for d in self.get("items"):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				...
				d.basic_rate = get_valuation_rate(
					...
					currency=prodman.get_company_currency(self.company),
					company=self.company,
	...
	def update_subcontracting_order_status(self):
		if self.subcontracting_order and self.purpose in ["Send to Subcontractor", "Material Transfer"]:
			from prodman.subcontracting.doctype.subcontracting_order.subcontracting_order import (
	...
	def update_pick_list_status(self):
		from prodman.stock.doctype.pick_list.pick_list import update_pick_list_status
