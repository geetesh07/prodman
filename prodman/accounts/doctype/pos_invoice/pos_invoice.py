...
from prodman.controllers.queries import item_query as _item_query
...
class POSInvoice(SalesInvoice):
	...
	def validate(self):
		...
		if self.coupon_code:
			from prodman.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from prodman.accounts.doctype.pricing_rule.utils import update_coupon_code_count
