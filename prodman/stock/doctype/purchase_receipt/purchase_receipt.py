...
from prodman.assets.doctype.asset.asset import get_asset_account, is_cwip_accounting_enabled
from prodman.buying.utils import check_on_hold_or_closed_status
from prodman.controllers.accounts_controller import merge_taxes
from prodman.controllers.buying_controller import BuyingController
from prodman.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from prodman.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def make_item_gl_entries(self, gl_entries, warehouse_account=None):
		...
		for d in self.get("items"):
			if (
				...
				if not (
					(prodman.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
