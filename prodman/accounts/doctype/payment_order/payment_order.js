...
nts .ui.form.on("Payment Order", {
	...
	get_from_payment_entry: function (frm) {
		...
		prodman.utils.map_current_doc({
			method: "prodman.accounts.doctype.payment_entry.payment_entry.make_payment_order",
	...
	get_from_payment_request: function (frm) {
		frm.trigger("remove_row_if_empty");
		prodman.utils.map_current_doc({
			method: "prodman.accounts.doctype.payment_request.payment_request.make_payment_order",
			...
			fields: [
				{
					...
					get_query: function () {
						return {
							query: "prodman.accounts.doctype.payment_order.payment_order.get_supplier_query",
...

				{
					...
					get_query: function () {
						return {
							query: "prodman.accounts.doctype.payment_order.payment_order.get_mop_query",
							filters: { parent: frm.doc.name },
						};
					},
				},
