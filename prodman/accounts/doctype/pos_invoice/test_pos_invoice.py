...
from prodman.accounts.doctype.pos_invoice.pos_invoice import PartialPaymentValidationError, make_sales_return
...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_delivered_serial_no_case(self):
		from prodman.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
