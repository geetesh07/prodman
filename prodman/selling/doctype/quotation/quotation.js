...
prodman.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
...
prodman.selling.QuotationController = class QuotationController extends prodman.selling.SellingController {
	onload(doc, dt, dn) {
