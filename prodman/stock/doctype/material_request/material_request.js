		...
		frappe.prompt(
			{
				...
				get_query: () => {
					return {
						query: "prodman.stock.doctype.material_request.material_request.get_default_supplier_query",
...
prodman.buying.MaterialRequestController = class MaterialRequestController extends (
...
extend_cscript(cur_frm.cscript, new prodman.buying.MaterialRequestController({ frm: cur_frm }));
