...
from prodman.stock.doctype.item.item import get_item_defaults, get_uom_conv_factor
from prodman.stock.doctype.item_manufacturer.item_manufacturer import get_item_manufacturer_part_no
from prodman.stock.doctype.price_list.price_list import get_price_list_details
...
def get_price_list_rate(args, item_doc, out=None):
	...
	if meta.get_field("currency") or args.get("currency"):
		...
		if (
			...
			from prodman.stock.doctype.item.item import get_last_purchase_details
