...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from prodman.crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from prodman.crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
